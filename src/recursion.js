...
var sum = function(array) {
  ...
  return array[back] + sum(array.slice(0,array.length- 1))
...
var createArray = function(str) {
  ...
  return outputArr.concat(createArray(str.slice(1, str.length)))
};
...
var reverseArr = function(array) {
  ...
  return reversedArr.concat(reverseArr(array));
};
...
var fizzBuzz = function(n) {
  ...
  return fizzBuzz(n-1).concat(fNbArr)
};
...
var rMap = function(array, callback) {
  ...
  return mappedArr.concat(rMap(array.slice(1, array.length), callback))
};
...
var capitalizeFirst = function(array) {
  ...
  return capitalW.concat(capitalizeFirst(array.slice(1,array.length)));
...
var compress = function(list) {
  var compOut = [];
  var listCopy = list.slice(0,list.length);
  ...
  if(listCopy[0] === listCopy[1]){
    while(listCopy[0] === listCopy[1]){
      listCopy.shift();
    }
  }
  compOut.push(listCopy[0]);

    return compOut.concat(compress(listCopy.slice(1,listCopy.length)))
};
